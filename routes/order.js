...
router.post("/confirmOrderMail", async (request, response) => {
  ...
  let { email, userName, OrderDate, subTotal, Discount, OrderTotal, Status, orderId, address } = request.body;
                                                                        ...
                                                                        <td class="esd-container-frame" width="280" align="left">
                                                                            <table style="border-left:1px solid transparent;border-right:1px solid transparent;border-top:1px solid transparent;border-bottom:1px solid transparent;background-color: #efefef; border-collapse: separate; background-position: center top;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#efefef">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p20t es-p10b es-p20r es-p20l" align="left">
                                                                                            <h4 style="color: #df4c48;">Delivery Address:</h4>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p20b es-p20r es-p20l" align="left">
                                                                                            <p>${address}</p>
                                                                                            <p>Somewhere, India 99743</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                        ...
                                                                                        <td align="left" class="esd-block-text es-p10t">
                                                                                            <table border="0" cellspacing="1" cellpadding="1" style="width:500px;" class="cke_show_border">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <h4 style="color: #333333; line-height: 200%;">Subtot<strong>al :</strong></h4>
                                                                                                        </td>
                                                                                                        <td style="color: #cc0033;"><strong>$ ${subTotal}</strong></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <h4 style="color: #333333; line-height: 200%;">Delivery Fee:</h4>
                                                                                                        </td>
                                                                                                        <td style="color: #cc0033;"><strong>Free</strong></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <h4 style="color: #333333; line-height: 200%;">Discount:</h4>
                                                                                                        </td>
                                                                                                        <td style="color: #cc0033;"><strong>$ ${Discount}</strong></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <h4 style="color: #333333; line-height: 200%;">Order Total:</h4>
                                                                                                        </td>
                                                                                                        <td style="color: #cc0033;"><strong>$ ${OrderTotal}</strong></td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
